...
\begin{figure}[h]
	\begin{floatrow}
		...
		\ffigbox{\includegraphics[width=1\linewidth]{Images/Results/elu}}{	\caption[Exponential Linear Unit (ELU)]{Exponential Linear Unit (ELU) Activation Function, with $\alpha = 0.5$.}
			\label{fig:elu}}
...
\begin{figure}[h]
	\ffigbox{
		\begin{subfloatrow}
			...
			\ffigbox{\includegraphics[width=1\linewidth]{Images/Results/Training/COVNET_MO_R2_2}}{
