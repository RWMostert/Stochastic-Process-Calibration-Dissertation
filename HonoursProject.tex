...
\begin{figure}[h]
	\begin{floatrow}
		 ...
		 \ffigbox{\includegraphics[width=1\linewidth]{Images/Results/relu}}{\caption[Rectifier Activation Function, f(x)]{Rectifier Activation Function (\acrshort{relu}), $f(x)$.}\label{fig:relu}}
...
\lstinputlisting[language=Python]{Merton_Jump_Diffusion_SDE_Utilities.py}
